...
* Revisit [**PSYC401**](https://modules.lancaster.ac.uk/course/view.php?id=40622#coursecontentcollapse1) to remind yourself of how to access the RStudio Server.

#### Get your files ready
Download the [402_week11_forStudents.zip](data/week11/402_week11_forStudents.zip) file and upload it into a new folder in RStudio Server. 
...
> **QUESTION 3**
According to the scatterplots, how would you describe the relationships between trustworthiness
...
### Lab activity 2: Conducting simple and multiple regression
You can download the R-script that includes the relevant code and answers to the questions here: [402_wk11_labAct2_withAnswers.R](data/week11/402_wk11_labAct2_withAnswers.R).